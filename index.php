    ...
    <body id="page-top">
        ...
        <nav id="sidebar-wrapper">
            <ul class="sidebar-nav">
                <li class="sidebar-brand"><a href="#page-top">ETEC</a></li>
                <li class="sidebar-nav-item"><a href="#page-top">Início</a></li>
                <li class="sidebar-nav-item"><a href="#about">Sobre</a></li>
                <li class="sidebar-nav-item"><a href="#portfolio">Cursos</a></li>
                <li class="sidebar-nav-item"><a href="#contact">Log In</a></li>
            </ul>
        </nav>
        <!-- Header-->
        <header class="masthead d-flex align-items-center">
            <div class="container px-4 px-lg-5 text-center">
                <h1 class="mb-1">Etec - MCM</h1>
                <h3 class="mb-5"><em>Centro Paula Souza</em></h3>
        ...
        <section class="content-section" id="portfolio">
            <div class="container px-4 px-lg-5">
                <div class="content-section-heading text-center">
                    ...
                    <h2 class="mb-5">Nossos cursos técnicos</h2>
                </div>
                <div class="row gx-0">
                    <div class="col-lg-6">
        ...
        <footer class="footer text-center">
            <div class="container px-4 px-lg-5">
                ...
                <p class="text-muted small mb-0">Copyright &copy; Luiz Lima</p>
            </div>
        </footer>
